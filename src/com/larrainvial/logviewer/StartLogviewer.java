...
import com.larrainvial.logviewer.model.ModelDolar;
import com.larrainvial.logviewer.utils.Helper;
import com.larrainvial.logviewer.utils.Latency;
...
public class StartLogviewer {

    private Logger logger = Logger.getLogger(this.getClass().getName());


    public StartLogviewer(Stage primaryStage){
        ...
        try {
            ...
            Repository.rootLayout_Loader.setLocation(StartLogviewer.class.getResource("view/rootLayout.fxml"));
            BorderPane rootLayout_Loader = (BorderPane) Repository.rootLayout_Loader.load();

            Repository.principalTabPanel_Loader.setLocation(StartLogviewer.class.getResource("view/PrincipalTabPanel.fxml"));
