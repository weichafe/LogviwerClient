package com.larrainvial.menu.Process;
...
public class Process {
    ...
    public Process(Stage primaryStage, String properties) {
        ...
        try {
            ...
            loader = new FXMLLoader(StartLogviewer.class.getResource("view/process/Process.fxml"));
    ...
    public void process(Stage primaryStage, String properties) {
        ...
        try {
            ...
            core.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<ModelProcess, ModelProcess>, ObservableValue<ModelProcess>>() {
                @Override
    ...
    public void printConsole(final ModelProcess modelProcess, final String aux, boolean print) throws Exception {
    ...
    public void buttonStyle(final ModelProcess core, final Session sesion, final boolean print) {
